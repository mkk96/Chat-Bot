<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/Admin.master" CodeFile="AddGenNotice.aspx.cs" Inherits="AddGenNotice" %>
     ...
     <div class="container-student text-left" style="width:40%">
                    <div class="row">
                        ...
                        <asp:TextBox ID="TextBox1" runat="server" placeholder="Title" required></asp:TextBox>
                              ...
                              <label for="contact">General Notice</label><br />
