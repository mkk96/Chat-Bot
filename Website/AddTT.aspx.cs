...
public partial class AddTT : System.Web.UI.Page
{
    string image, path;
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        if (Session["Add"] == "Data")
        {
            Page.ClientScript.RegisterStartupScript(GetType(), "msgbox", "alert('Time Table Added');", true);
            Session["Add"] = "";
        }
    ...
    {
        SqlCommand cmd = new SqlCommand("Insert into timeTable Values ('" + DropDownList1.Text + "','" + DropDownList2.Text + "','" + Image1.ImageUrl + "')", con);
        con.Open();
        cmd.ExecuteNonQuery();
        con.Close();
        Session["Add"] = "Data";
        Response.Redirect("AddTT.aspx");
    }
}