...
public partial class ViewSylabus : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sql1 = "select sylab from Sylab where  course='"+course+"' and div='"+div+"'";
        ...
        {
            Page.ClientScript.RegisterStartupScript(GetType(), "msgbox", "alert('Currently, No Sylabus Added');", true);
        }
    }
}