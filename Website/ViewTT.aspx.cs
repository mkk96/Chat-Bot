...
public partial class ViewTT : System.Web.UI.Page
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string sql1 = "select image from timeTable where  course='" + course + "' and div='" + div + "'";
        ...
        {
            Page.ClientScript.RegisterStartupScript(GetType(), "msgbox", "alert('Currently, No Time-Table Added');", true);
        }
    }
}